...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'problems.search.errorInsufficientPoints': 'Insufficient points. Please upload problems to earn points before searching.',
    ...
    'problems.search.comment': 'Comment Ratio',
    'problems.search.comment_full': 'Share of valid comments that support the answer',
    ...
    'problems.search.otherNotesTitle': 'Other Notes Search Results',
    ...
    'aiSummary.title': 'AI Comment Profile',
    'aiSummary.loading': 'Loading...',
    'aiSummary.emptyState': 'No AI profile yet for this user.',
    'aiSummary.generate': 'Generate AI Profile',
    'aiSummary.generating': 'Generating, please wait (this can take up to a minute)...',
    'aiSummary.refresh': 'Refresh (7+ days old)',
    'aiSummary.refreshLocked': 'Refresh',
    'aiSummary.retry': 'Retry',
    'aiSummary.lastGenerated': 'Generated {date} · {provider}',
    'aiSummary.error': 'Generation failed: {message}',
    'aiSummary.expressionStyle': 'Expression Style',
    'aiSummary.opinionTendency': 'Opinion Tendency',
    'aiSummary.interactionPattern': 'Interaction Pattern',
    'aiSummary.limitations': 'Data Limitations',
    'aiSummary.funGuessToggle': 'Fun text-based guesses (not factual)',
    'aiSummary.gender': 'Gender guess',
    ...
    'rankings.totalUsers': '{count} users total',
    'rankings.prev': 'Prev',
    'rankings.next': 'Next',
    'rankings.page': 'page',
    'rankings.jumpTo': 'Jump to',
    'rankings.go': 'Go',
    'rankings.pageOf': '{page} / {totalPages}',
    'rankings.searchPlaceholder': 'Search by nickname...',
  ...
  zh: {
    ...
    'problems.search.errorInsufficientPoints': '积分不足，请上传题目后获得积分。',
    'problems.search.resultsFor': '【{keyword}】的搜索结果',
    'problems.search.found': '找到 {total} 条结果，显示 {displayed} 条',
    ...
    'problems.search.comment': '评论区比例',
    'problems.search.comment_full': '有效评论中支持答案的比例',
    ...
    'problems.search.otherNotesTitle': '其他题库搜索结果',
    ...
    // AI user summary card
    'aiSummary.title': 'AI 评论画像',
    'aiSummary.loading': '加载中...',
    'aiSummary.emptyState': '该用户还没有生成 AI 画像。',
    'aiSummary.generate': '生成 AI 画像',
    'aiSummary.generating': '生成中，请稍候（可能需要最多一分钟）...',
    'aiSummary.refresh': '重新生成（已超过7天）',
    'aiSummary.refreshLocked': '重新生成',
    'aiSummary.retry': '重试',
    'aiSummary.lastGenerated': '生成于 {date} · {provider}',
    'aiSummary.error': '生成失败：{message}',
    'aiSummary.expressionStyle': '表达风格',
    'aiSummary.opinionTendency': '观点倾向',
    'aiSummary.interactionPattern': '互动模式',
    'aiSummary.limitations': '数据局限',
    'aiSummary.funGuessToggle': '娱乐性文字联想（非事实）',
    'aiSummary.gender': '性别猜测',
    ...
    'rankings.totalUsers': '共 {count} 位用户',
    'rankings.prev': '上一页',
    'rankings.next': '下一页',
    'rankings.page': '页',
    'rankings.jumpTo': '跳转到',
